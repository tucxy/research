...
\begin{figure}[H]
\centering
        \scalebox{0.4}{\input{Danny's example/chart}}
...
%        \node[anchor=east] (file1) at (0, 0) {\input{Danny's example/Sigma/T-(6,6)}};
%        \node[anchor=east] (Lfile1) at (0.79,-2.5) {$(4,1,8,5,6,7)$};
        % Union symbol
        
        % Second standalone file
%        \node[anchor=west] (file2) at (1, 0) {\input{Danny's example/Sigma/T-(3,1)}};
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=0.5]
        ...
        % Second standalone file
        \node[anchor=west] (file2) at (0.001, -0.62) {\input{Danny's example/Sigma/T-(3,1)}};
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% second column %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{scope}[shift = {(7.75,0)}]
        ...
        %G2
        \node[anchor=east] (file1) at (0, -3) {\input{Danny's example/7 mod 14/2-T-(6,6)}};
        
        \node[anchor=west] (file2) at (0.001, -3.62) {\input{Danny's example/7 mod 14/2-T-(3,1)}};
        ...
        %G4
        \node[anchor=east] (file1) at (0.246, -9) {\input{Danny's example/7 mod 14/4-T-(6,6)}};
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% third column %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{scope}[shift={(17,0)}]
        ...
        \draw[->] (4,0.01) -- (4,0.01) node[draw = none,midway, text=black, fill=white] {$\overset{+7}{\circlearrowright}$};
        %G2
        \node[anchor=east] (file1) at (0, -3) {\input{Danny's example/8 mod 14/2-T-(6,6)}};
        
        \node[anchor=west] (file2) at (0.001, -3.62) {\input{Danny's example/8 mod 14/2-T-(3,1)}};
        ...
        \draw[->] (4,-6.01) -- (4,-6.01) node[draw = none,midway, text=black, fill=white] {$\overset{+7}{\circlearrowright}$};
        %G4
        \node[anchor=east] (file1) at (0, -9) {\input{Danny's example/8 mod 14/4-T-(6,6)}};
...
\begin{proof}
     ...
     %The table will contain ad-hoc decompositions of $K_{21}$ and $K_{22}$. The construction for $K_{21}$ results from plucking edges off of Pauline Cain's $7$-star decomposition of $K_{21}$ and mixing them around, and The construction for $K_{22}$ results from adding three stars centered at $\infty$ and three lone paths beginning at $\infty$. Once again, edges are plucked off and mixed around to make this work.
\end{proof}
