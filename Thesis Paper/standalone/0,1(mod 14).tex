...
\begin{document}
\centering
\renewcommand{\arraystretch}{1.25} % Adjust row height multiplier (padding)
\resizebox{1.005\textwidth}{!}{%
\begin{tabular}{|c|c|c|c|}
\hline
Forest & Vertex Labels & Forest & Vertex Labels \\
\hline
    $\mathbf{T_{7}^{1}} \sqcup \mathbf{T_{2}^{1}}$ &  $(0,6,1,5,2,9,7)\sqcup(3,4)$  &     $\mathbf{T_{7}^{3}} \sqcup \mathbf{T_{2}^{1}}$ &  $(9,2,5,1,6,0,3)\sqcup(8,7)$  \\
\hline
    $\mathbf{T_{7}^{2}} \sqcup \mathbf{T_{2}^{1}}$ &  $(9,2,5,1,6,0,4)\sqcup(8,7)$  &     $\mathbf{T_{7}^{4}} \sqcup \mathbf{T_{2}^{1}}$ &  $(5,1,4,2,9,6,7)\sqcup(10,11)$  \\
\hline
    $\mathbf{T_{7}^{5}} \sqcup \mathbf{T_{2}^{1}}$ &  $(3,8,1,4,2,5,7)\sqcup(9,10)$  &     $\mathbf{T_{7}^{8}} \sqcup \mathbf{T_{2}^{1}}$ &  $(7,8,1,6,0,4,3)\sqcup(9,11)$  \\
\hline
    $\mathbf{T_{7}^{9}} \sqcup \mathbf{T_{2}^{1}}$ &  $(8,1,6,3,4,5,7)\sqcup(9,10)$  &     $\mathbf{T_{7}^{10}} \sqcup \mathbf{T_{2}^{1}}$ &  $(6,1,5,3,8,4,7)\sqcup(9,10)$  \\
\hline
    $\mathbf{T_{7}^{6}} \sqcup \mathbf{T_{2}^{1}}$ &  $(5,11,9,10,6,12,7)\sqcup(8,1)$  &     $\mathbf{T_{7}^{7}} \sqcup \mathbf{T_{2}^{1}}$ &  $(4,8,1,6,0,5,3)\sqcup(9,10)$  \\
\hline
    $\mathbf{T_{6}^{1}} \sqcup \mathbf{T_{3}^{1}}$ &  $(0,6,1,5,2,9)\sqcup(11,10,12)$  &     $\mathbf{T_{6}^{2}} \sqcup \mathbf{T_{3}^{1}}$ &  $(3,6,1,8,4,0)\sqcup(10,9,11)$  \\
\hline
    $\mathbf{T_{6}^{3}} \sqcup \mathbf{T_{3}^{1}}$ &  $(5,11,9,12,7,10)\sqcup(1,8,4)$  &     $\mathbf{T_{6}^{4}} \sqcup \mathbf{T_{3}^{1}}$ &  $(3,8,4,1,6,7)\sqcup(10,9,11)$  \\
\hline
    $\mathbf{T_{6}^{5}} \sqcup \mathbf{T_{3}^{1}}$ &  $(5,1,8,3,4,7)\sqcup(10,9,11)$  &     $\mathbf{T_{6}^{6}} \sqcup \mathbf{T_{3}^{1}}$ &  $(4,1,8,5,6,7)\sqcup(10,9,11)$  \\
\hline
    $\mathbf{T_{5}^{1}} \sqcup \mathbf{T_{4}^{1}}$ &  $(0,6,1,5,2)\sqcup(9,8,10,3)$  &     $\mathbf{T_{5}^{2}} \sqcup \mathbf{T_{4}^{1}}$ &  $(7,1,8,5,6)\sqcup(0,4,2,3)$  \\
\hline
    $\mathbf{T_{5}^{2}} \sqcup \mathbf{T_{4}^{2}}$ &  $(7,1,8,4,6)\sqcup(10,9,11,12)$  &     $\mathbf{T_{5}^{3}} \sqcup \mathbf{T_{4}^{1}}$ &  $(6,0,3,4,5)\sqcup(8,7,9,2)$  \\
\hline
    $\mathbf{T_{5}^{1}} \sqcup \mathbf{T_{4}^{2}}$ &  $(4,8,1,7,2)\sqcup(10,9,11,12)$  &     $\mathbf{T_{5}^{3}} \sqcup \mathbf{T_{4}^{2}}$ &  $(6,0,3,4,5)\sqcup(8,9,2,7)$  \\
\hline
