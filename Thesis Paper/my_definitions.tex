...
\usepackage{enumerate,enumitem,multirow,caption,subcaption,tabu,array,tabularx,longtable}
...
\usepackage[ansinew]{inputenc}   % ansinew = Windows-1252
\usepackage{xcolor}
\usepackage{listings}
\lstset{
  inputencoding=ansinew,
  extendedchars=true,
  literate={∞}{{\ensuremath{\infty}}}1,
  language=Python,
