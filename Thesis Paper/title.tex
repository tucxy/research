...
\title{\bf Seven Edge Forest Designs}
\author{Daniel Mauricio Banegas}
\campus{University of Minnesota: Duluth} 
\program{Mathematics} 
\degree{MASTER OF SCIENCE}
\director{Dr. Bryan Freyberg}

% Optionally specify the month and year.
%\submissionmonth{} % defaults to current month.
%\submissionyear{} % defaults to current year.
...
% look for “<date macro>,” and remove the comma
