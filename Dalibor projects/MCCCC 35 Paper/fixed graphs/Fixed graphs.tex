...
\begin{tikzpicture}[scale=0.6]
    ...
    \node[draw, circle]  (6) at (-60: 2 cm) {6};
    \node[draw, circle] (11) at ($(6) + (-120:2cm)$) {13};
...
\begin{scope}[shift={(8,0)}] % shift right
    ...
    % sticks
% Adding three line segments with nodes
\node[draw, circle] (7) at ($(6) + (1, 0)$) {7};
\node[draw, circle] (4) at ($(0) + (2, 0)$) {4};
\draw (7)--(4) node [draw = none, midway,left,sloped, fill = none, rotate=90] {$3$};

\node[draw, circle] (1) at ($(6) + (2, 0)$) {1};
\node[draw, circle] (10) at ($(11) + (3, 0)$) {10};
\draw (10)--(1) node [draw = none, near start, right,sloped, fill = none, rotate=90] {$4(9)$};

\node[draw, circle] (3) at ($(6) + (3, 0)$) {3};
\node[draw, circle] (2) at ($(0) + (4, 0)$) {2};
\draw (2)--(3) node [draw = none, midway,left,sloped, fill = none, rotate=90] {$1$};

\node[draw, circle] (12) at ($(6) + (4, 0)$) {$\infty$};
...
%key
\begin{scope}[shift={(current bounding box.west)}, shift={(-3,1.85)}, every node/.style={draw=none, fill=none}]
    \draw (0,0) node (A) {\textcolor{red}{$A$}};
    \draw  (-90: 1.73 cm) node (B) {\textcolor{blue}{$B$}};
    \draw  (-90: 3.46 cm) node (C) {\textcolor{dgreen}{$C$}};
...
\begin{tikzpicture}[scale=0.6]
    ...
    \node[draw, circle]  (62) at (-60: 2 cm) {6};
    \node[draw, circle] (112) at ($(62) + (-120:2cm)$) {13};
    ...
    \node[draw, circle] (72) at ($(42) + (120:2cm)$) {7};
    \node[draw, circle] (52) at ($(42) + (60:2cm)$) {8};
    ...
    \node[draw, circle] (1) at ($(02) + (5, 0)$) {1};
    \node[draw, circle] (10) at ($(62) + (4, 0)$) {4};
    \draw (10)--(1) node [draw = none, midway, left,sloped, fill = none, rotate=90] {$3$};

    \node[draw, circle] (92) at ($(62) + (5, 0)$) {3};
    \node[draw, circle] (22) at ($(02) + (6, 0)$) {2};
    \draw (22)--(92) node [draw = none, midway,left,sloped, fill = none, rotate=90] {$1$};
%1-rotational
    \begin{scope}[shift={(8,0)}] % shift right
    \node[draw, circle] (02) at (0,0) {0};
    \node[draw, circle] (62) at (-60: 2 cm) {6};
    \node[draw, circle] (112) at ($(62) + (-120:2cm)$) {11};

    \draw (02)--(112) node [draw = none, midway,left,sloped, fill = none, rotate=90] {$2$};
    \draw (02)--(62) node [draw = none, midway,above right,sloped, fill = none, rotate=60] {$6$};
    \draw (112)--(62) node [draw = none, midway,below right,sloped, fill = none, rotate=-60] {$5(5)$};

    \node[draw, circle] (42) at ($(02) + (3, 0)$) {4};
    \node[draw, circle] (72) at ($(42) + (-120:2cm)$) {7};
    \node[draw, circle]  (52) at ($(42) + (-60:2cm)$) {5};
    ...
    \node[draw, circle] (1) at ($(62) + (4, 0)$) {1};
    \node[draw, circle] (10) at ($(112) + (5, 0)$) {10};
    \draw (10)--(1) node [draw = none, near start, left,sloped, fill = none, rotate=90] {$4(9)$};

    \node[draw, circle] (92) at ($(62) + (5, 0)$) {$\infty$};
    \node[draw, circle] (22) at ($(02) + (6, 0)$) {2};
    ...
    \useasboundingbox (current bounding box.south west) rectangle (current bounding box.north east);
    %key
    \begin{scope}[shift={(current bounding box.west)}, shift={(-2.6,1.85)}, every node/.style={draw=none, fill=none}] % shift right
    \draw (0,0) node (A) {\textcolor{red}{$A$}};
    \node  (B) at (-90: 1.73 cm) {\textcolor{blue}{$B$}};
    \node  (C) at (-90: 3.46 cm) {\textcolor{dgreen}{$C$}};
...
% C_{3}
\draw (0,0) node (0) [label=above:{\color{red}$0$}]{};
\node  (6) at (-60: 2 cm) [label=below right:{\color{blue}$6$}]{};
\node (11) at ($(6) + (-120:2cm)$) [label=below:{\color{dgreen}$13$}]{};
...
\draw (11)--(6) node [draw = none, midway,below right,sloped, fill = none, rotate=-60] {$7(7)$};
    % sticks
% Adding three line segments with nodes
\node (4) at ($(0) + (2, 0)$) [label=above:{\color{red}$7$}]{};
\node (2) at ($(0) + (3, 0)$) [label=above:{\color{red}$8$}]{};
\node (1) at ($(6) + (2, 0)$) [label=below:{\color{blue}$12$}]{};
\node (8) at ($(0) + (4, 0)$) [label=above:{\color{red}$9$}]{};
\draw (1)--(4) node [draw = none, midway,left,sloped, fill = none, rotate=60] {$5$};
\draw (1)--(2) node [draw = none, near end,left,sloped, fill = none, rotate=90] {$4$};
\draw (1)--(8) node [draw = none, midway,right,sloped, fill = none, rotate=-60] {$3$};

\node (12) at ($(0) + (5, 0)$) [label=above:{\color{red}$1$}]{};
\node (3) at ($(6) + (4, 0)$) [label=below:{\color{blue}$2$}]{};
...
\draw (0,0) node (0) [label=above:{\color{red}$0$}]{};
\node  (6) at (-60: 2 cm) [label=below right:{\color{blue}$6$}]{};
\node (11) at ($(6) + (-120:2cm)$) [label=below:{\color{dgreen}$11$}]{};
...
\draw (11)--(6) node [draw = none, midway,below right,sloped, fill = none, rotate=-60] {$5(5)$};
    % sticks
% Adding three line segments with nodes
\node (4) at ($(6) + (1, 0)$) [label=below:{\color{blue}$4$}]{};
\node (2) at ($(6) + (2, 0)$) [label=below:{\color{blue}$2$}]{};
\node (1) at ($(0) + (3, 0)$) [label=above:{\color{red}$1$}]{};
\node (8) at ($(6) + (3, 0)$) [label=below:{\color{blue}$\infty$}]{};
...
\node (12) at ($(11) + (5, 0)$) [label=below:{\color{dgreen}$12$}]{};
\node (3) at ($(6) + (4, 0)$) [label=above:{\color{blue}$3$}]{};
\draw (3)--(12) node [draw = none, midway,right,sloped, fill = none, rotate=-90] {$4(9)$};

\end{scope}
\useasboundingbox (current bounding box.south west) rectangle (current bounding box.north east);
%key
\begin{scope}[shift={(current bounding box.west)}, shift={(-2.6,1.85)}, every node/.style={draw=none, fill=none}] 
    \draw (0,0) node (A) {\textcolor{red}{$A$}};
    \node  (B) at (-90: 1.73 cm) {\textcolor{blue}{$B$}};
    \node  (C) at (-90: 3.46 cm) {\textcolor{dgreen}{$C$}};
...
\begin{tikzpicture}[scale=0.6]
    ...
    \draw (0,0) node (02) [label=above:{\color{red}$0$}]{};
    \node  (62) at (-60: 2 cm) [label=below:{\color{blue}$6$}]{};
    \node (112) at ($(62) + (-120:2cm)$) [label=below:{\color{dgreen}$13$}]{};
    ...
    % Repeat of additional line segments
    \node (32) at ($(62) + (2, 0)$) [label=below:{\color{blue}$12$}]{};
    \node (122) at ($(32) + (60:2cm)$) [label=above:{\color{red}$8$}]{};
    \node  (22) at ($(32) + (120:2cm)$) [label=above:{\color{red}$7$}]{};
    \draw (32)--(122) node [draw = none, midway,left,sloped, fill = none, rotate=-60] {$4$};
    \draw (32)--(22) node [draw = none, midway,left,sloped, fill = none, rotate=60] {$5$};
    %
    \node (1b) at ($(62) + (5, 0)$) [label=below:{\color{blue}$4$}]{};
    \node (42) at ($(1b) + (120:2cm)$) [label=above:{\color{red}$1$}]{};
    \node (82) at ($(1b) + (60:2cm)$) [label=above:{\color{red}$3$}]{};
...
\begin{scope}[shift={(9,0)}] % shift right
    \draw (0,0) node (02) [label=above:{\color{red}$0$}]{};
    \node  (62) at (-60: 2 cm) [label=below:{\color{blue}$6$}]{};
    \node (112) at ($(62) + (-120:2cm)$) [label=below:{\color{dgreen}$11$}]{};
    ...
    % Repeat of additional line segments
    \node (32) at ($(62) + (2, 0)$) [label=below:{\color{blue}$3$}]{};
    \node (122) at ($(32) + (-120:2cm)$) [label=below:{\color{dgreen}$12$}]{};
    \node  (22) at ($(32) + (120:2cm)$) [label=above:{\color{red}$2$}]{};
    \draw (32)--(122) node [draw = none, midway,below right,sloped, fill = none, rotate=-60] {$4(9)$};
    \draw (32)--(22) node [draw = none, midway,above right,sloped, fill = none, rotate=60] {$1$};
    %
    \node (1b) at ($(02) + (5, 0)$) [label=above:{\color{red}$1$}]{};
    \node (42) at ($(1b) + (-120:2cm)$) [label=below:{\color{blue}$4$}]{};
    \node (82) at ($(1b) + (-60:2cm)$) [label=below:{\color{blue}$\infty$}]{};
    \draw (1b)--(42) node [draw = none, midway,above left,sloped, fill = none, rotate=-60] {$3$};
    \draw (1b)--(82) node [draw = none, midway,above right,sloped, fill = none, rotate=60] {$\infty$};
    \end{scope}
    \useasboundingbox (current bounding box.south west) rectangle (current bounding box.north east);
%key
\begin{scope}[shift={(current bounding box.west)}, shift={(-2.6,1.85)}, every node/.style={draw=none, fill=none}] 
...
\begin{tikzpicture}[scale=0.6]
    ...
    \draw (112)--(62) node [draw = none, midway,below right,sloped, fill = none, rotate=-60] {$7(7)$};
    % Repeat of additional line segments
    \node (32) at ($(62) + (1.5, 0)$) [label=below:{\color{blue}$12$}]{};
    \node (122) at ($(32) + (120:2cm)$) [label=above:{\color{red}$7$}]{};
    \node  (22) at ($(32) + (60:2cm)$) [label=above:{\color{red}$8$}]{};
    \node  (92) at ($(22) + (-60:2cm)$) [label=below:{\color{blue}$11$}]{};
    ...
    \node (42) at ($(62) + (5, 0)$) [label=below:{\color{blue}$2$}]{};
    \node (1b) at ($(02) + (6, 0)$) [label=above:{\color{red}$1$}]{};
...
\begin{scope}[shift={(8,0)}] 
    ...
    \draw (112)--(62) node [draw = none, midway,below right,sloped, fill = none, rotate=-60] {$5(5)$};
    % Repeat of additional line segments
    \node (32) at ($(62) + (1, 0)$) [label=below:{\color{blue}$3$}]{};
    \node (122) at ($(32) + (-60:2cm)$) [label=below:{\color{dgreen}$12$}]{};
    \node  (22) at ($(32) + (60:2cm)$) [label=above:{\color{red}$2$}]{};
    \node  (92) at ($(22) + (-60:2cm)$) [label=below:{\color{blue}$\infty$}]{};
    ...
    \node (42) at ($(62) + (4, 0)$) [label=below:{\color{blue}$4$}]{};
    \node (1b) at ($(02) + (5, 0)$) [label=above:{\color{red}$1$}]{};
