...
\begin{scope}[shift={(10,0)}] % shift right
    \node[draw,circle] (0) at (0,0) {0};
    \node[draw, circle]  (6) at (-60: 3 cm) {6};
...
\draw (11)--(6) node [draw = none, midway,below right,sloped, fill = none, rotate=-60] {$5(5)$};
    % sticks
% Adding three line segments with nodes
\node[draw, circle] (4) at ($(6) + (1, 0)$) {4};
\node[draw, circle] (2) at ($(6) + (2, 0)$) {2};
\node[draw, circle] (1) at ($(0) + (3, 0)$) {1};
\node[draw, circle] (8) at ($(6) + (3, 0)$) {$\infty$};
...
\node[draw, circle] (12) at ($(11) + (5, 0)$) {12};
\node[draw, circle] (3) at ($(6) + (4, 0)$) {3};
